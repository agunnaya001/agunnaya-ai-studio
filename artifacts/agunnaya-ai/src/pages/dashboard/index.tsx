          ...
          <div className="max-w-6xl space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <ChecklistItem done={true} label="Create account" />
                <ChecklistItem done={user?.user_metadata?.email_verified} label="Verify email" />
                <ChecklistItem done={false} label="Set up API keys" />
                <ChecklistItem done={false} label="Create first project" />
                <ChecklistItem done={false} label="Generate first contract" />
              </div>
            </div>
          </div>
        </main>
